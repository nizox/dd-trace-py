...
class HttpRequest(object):
    ...
    headers = attr.ib(type=Mapping[str, List[str]])
...
class HttpResponse(object):
    ...
    headers = attr.ib(type=Mapping[str, List[str]], default=None)
...
class Context_0_1_0(object):
    library = attr.ib(type=Library_0_1_0)
